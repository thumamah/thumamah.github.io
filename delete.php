                ...
                <form action="delete_process.php" method="POST" class="form">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="RegistrationNumber" class="form-label">Registration Number (use Dublin
                                registration) </label>
                            <input type="text" disabled="disabled" name="id" class="form-control" maxlength=20 value=" <?php echo $row['Registration_Number']; ?>" required>
